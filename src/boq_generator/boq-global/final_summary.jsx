...
const FinalSummary = ({ props }) => {
  ...
  const renderTable = () => {
    ...
    const roofSummary = props.summaries.find((summary) => summary.type === "roof");

        //"roof" summary
        const roofdes = roofSummary
        ? roofSummary.summary.description
        : 0;
      const roofQuantity = roofSummary
        ? roofSummary.summary.quantity

        : 0;
      const roofRate = roofSummary
        ? roofSummary.summary.rate
        : 0;
      const roofAmount = roofSummary
        ? roofSummary.summary.totalPrice
        : 0;
          ...
          <table className="mx-auto min-w-3/4 table-auto">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th className="border px-4 py-2 px-4 py-2"></th>
                <th className="border px-4 py-2 px-4 py-2">{(wallAmount + wallfAmount).toFixed(2)}</th>
              </tr>
              <tr className="">
              ...
              <tr>
                ...
                <td className="border px-4 py-2"></td>
                <td className="border px-4 py-2"></td>
                <td className="border px-4 py-2">{((slabfQuantity * 880) + slabAmount + slabfAmount).toFixed(2)}</td>
              </tr>
              <tr>
              ...
              <tr>
                <th className="border px-4 py-2 px-4 py-2">TOTAL FOR STAIR SUMMARY</th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(stairConcrete + stairReinforcement + stairFormwork).toFixed(2)}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(footingsConcrete + footingsReinforcement + footingsFormwork).toFixed(2)}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(columnConcrete + columnReinforcement + columnFormwork).toFixed(2)}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(tiebeamConcrete + tiebeamReinforcement + tiebeamFormwork).toFixed(2)}</th>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(foundationConcrete + foundationFormwork).toFixed(2)}</th>
              </tr>
              <tr>
              ...
              <tr>
                <th className="border px-4 py-2 px-4 py-2">TOTAL FOR ROOF SUMMARY</th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{doorPrice}</th>
              ...
              <tr>
                <th className="border px-4 py-2">{roofdes}</th>
                <th className="border px-4 py-2">NOS</th>
                <th className="border px-4 py-2">{roofQuantity}</th>
                <th className="border px-4 py-2">{roofRate}</th>
                <th className="border px-4 py-2">{roofAmount}</th>
              </tr>
              <tr>
                ...
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">{(slabfQuantity * 950 +
                  slabAmount +
                  slabfAmount +
                  wallfAmount +
                  wallAmount +
                  footingsConcrete +
                  footingsReinforcement +
                  footingsFormwork +
                  columnConcrete +
                  columnReinforcement +
                  columnFormwork +
                  ...
                  foundationConcrete +
                  foundationFormwork +
                  windowPrice +roofAmount+
                  doorPrice).toFixed(2)}</th>
              </tr>
              <tr>
                <th className="border px-4 py-2 px-4 py-2">GET SUMMERY</th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2"></th>
                <th className="border px-4 py-2">        <button onClick={exportToPDF} className="bg-indigo-400 text-white py-1 px-2 rounded-md mt-2">Download Summary as PDF </button>
                </th>
              </tr>
            </tbody>
          </table>
