      ...
      <div className="services__raw">
        <div className="service__component">
          ...
          <p>
            ...
            electronic businesses, and social network services. We here at
            Texyto, provide you with web development services to build up your
            own platform for you to appear on the internet.
          </p>
        </div>
        <div className="service__component">
          ...
          <p>
            ...
            other software components. We do software development here at
            Texyto. If you have a need for tailor-made software for your own
            business, or organization; please contact us at Texyto and we are
            here to assist you.
          </p>
        </div>
        <div className="service__component">
          ...
          <p>
            ...
            traffic or paid traffic. We carry out SEO optimization for your web
            pages to generate unique and organic web traffic for you to reach
      ...
      <div className="services__raw">
        <div className="service__component">
          ...
          <p>
            ...
            in interactive designs, to optimize the user experience. Our team of
            brainstorming designers will come up with new ideas for all your
            graphical needs.
          </p>
        </div>
        <div className="service__component">
          ...
          <p>
            ...
            Webhosting) is the service of housing, serving, and maintaining
            files for one or more Web sites. More important than the computer
            space that is provided for Web site files is the fast connection to
            the Internet. Texyto provides you with web hosting services and 24/7
            unmatched customer support for all your web hosting needs.
          </p>
        </div>
        <div className="service__component">
          ...
          <h3>FREE LEARNING</h3>
          <p>
            Free learning is learning in which all choices are made by the
            student. Free learning is usually based on self-learning that is
            self-directed and self-paced. In free learning, there are no
            constraints of time, space, pace, method, direction, or subject
            matter. We here at Texyto, encourage free learning, and we provide
            multiple tutorials on various trades in IT.
          </p>
        </div>
      </div>
    </div>
